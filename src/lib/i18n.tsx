...
const en = {
  ...
  insights: {
    eyebrow: "Insights",
    heading: "Insights",
    sub: "Notes on delivery, data and enterprise systems, from the people doing the work.",
    readLabel: "read the article",
    minRead: "min read",
    backLabel: "All insights",
    filterLabel: "Filter by topic",
    allLabel: "All",
    latestLabel: "Latest insight",
    exploreLabel: "Explore by topic",
    latestGrid: "Latest insights",
    moreGrid: "More insights",
    empty: "Nothing published yet. Come back shortly.",
    noneInTopic: "Nothing under that topic yet.",
...
const fr: Copy = {
  ...
  insights: {
    eyebrow: "Insights",
    heading: "Insights",
    sub: "Notes sur la livraison, les données et les systèmes d'entreprise, par celles et ceux qui font le travail.",
    readLabel: "lire l'article",
    minRead: "min de lecture",
    backLabel: "Tous les insights",
    filterLabel: "Filtrer par sujet",
    allLabel: "Tout",
    latestLabel: "Dernier insight",
    exploreLabel: "Explorer par sujet",
    latestGrid: "Derniers insights",
    moreGrid: "Autres insights",
    empty: "Rien de publié pour l'instant. Revenez bientôt.",
    noneInTopic: "Rien sous ce sujet pour l'instant.",
    relatedLabel: "Insights liés",
  },
  about: {
