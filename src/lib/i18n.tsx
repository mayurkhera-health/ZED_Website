  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Who else sees it", body: "Our website host, Fly.io, which keeps standard server logs including IP addresses. Resend, which delivers contact form messages from our server to our inbox; if that delivery path is unavailable the form instead opens your own email application, in which case the message travels through your email provider rather than ours. Google Drive, where resumes are stored in a restricted folder reachable only by the people involved in hiring. [CONFIRM — the provider hosting our own email, which receives every enquiry and every resume before it reaches Drive.] Google Fonts, which serves the typeface on this site — your browser requests the font files from Google directly, so Google receives your IP address on every page load. That is a normal part of how the site is built, but it is a transfer, so it is named here. No CRM, applicant tracking system or recruiting platform receives any of this: enquiries and applications are read in our own email." },
        ...
        { heading: "If you are in Canada", body: "If you are in Canada, you have comparable rights. You can ask what personal information we hold about you, ask us to correct it if it is wrong, and withdraw your consent to our holding it — though if you withdraw it while we are considering your application, we will not be able to carry on considering you. Enquiries and resumes are stored in the United States, so information about you leaves Canada when you send it to us. Write to info@zedventures.com, and if our answer does not satisfy you, you can complain to the Office of the Privacy Commissioner of Canada, to the Commission d'accès à l'information du Québec, or to the Office of the Information and Privacy Commissioner of Alberta. [CONFIRM WITH COUNSEL — this paragraph is a plain-language draft of rights that exist under PIPEDA, Quebec's Law 25 and Alberta's PIPA. It is written to be checked, not published as it stands. Three things it does not yet do: state Law 25's data-portability right; name the person responsible for the protection of personal information, which Law 25 requires be published with contact details and which is a change to this page rather than a clause in it; or address the breach-notification duties Quebec and Alberta each carry. Whether any of this attaches, given that ZEDventures has no Canadian establishment, is the threshold question.]" },
  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Qui d'autre y a accès", body: "Notre hébergeur, Fly.io, qui conserve des journaux serveur standard incluant les adresses IP. Resend, qui achemine les messages du formulaire depuis notre serveur vers notre boîte de réception ; si cette voie est indisponible, le formulaire ouvre votre propre application de courriel et le message transite alors par votre fournisseur plutôt que par le nôtre. Google Drive, où les CV sont conservés dans un dossier à accès restreint, réservé aux personnes participant au recrutement. [À CONFIRMER — le fournisseur qui héberge notre propre messagerie, qui reçoit chaque demande et chaque CV avant leur dépôt dans Drive.] Google Fonts, qui fournit la police de caractères du site — votre navigateur télécharge les fichiers de police directement auprès de Google, qui reçoit donc votre adresse IP à chaque chargement de page. Cela relève de la construction du site, mais il s'agit d'un transfert : il est donc mentionné ici. Aucun CRM, ATS ou plateforme de recrutement ne reçoit ces données : les demandes et les candidatures sont lues dans notre propre messagerie." },
        ...
        { heading: "Si vous êtes au Canada", body: "Si vous êtes au Canada, vous disposez de droits comparables. Vous pouvez demander quels renseignements personnels nous détenons à votre sujet, en demander la rectification s'ils sont inexacts, et retirer votre consentement — étant entendu que si vous le retirez pendant l'examen de votre candidature, nous ne pourrons pas poursuivre cet examen. Les demandes et les CV sont conservés aux États-Unis : vos renseignements sortent donc du Canada lorsque vous nous les transmettez. Écrivez à info@zedventures.com ; si notre réponse ne vous satisfait pas, vous pouvez porter plainte auprès du Commissariat à la protection de la vie privée du Canada, de la Commission d'accès à l'information du Québec, ou du Commissariat à l'information et à la protection de la vie privée de l'Alberta. [À CONFIRMER AVEC UN CONSEIL JURIDIQUE — ce paragraphe est une rédaction en langage clair de droits prévus par la LPRPDE, la Loi 25 québécoise et la PIPA albertaine. Il est destiné à être vérifié, non publié tel quel. Trois éléments y manquent : le droit à la portabilité prévu par la Loi 25 ; la désignation de la personne responsable de la protection des renseignements personnels, dont la Loi 25 exige la publication avec ses coordonnées — une modification de cette page et non une clause à y insérer ; et les obligations de notification des incidents propres au Québec et à l'Alberta. La question préalable reste de savoir lesquelles de ces obligations s'appliquent, ZEDventures n'ayant pas d'établissement au Canada.]" },
