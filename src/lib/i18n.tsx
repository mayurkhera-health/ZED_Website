...
const en = {
  ...
  legalPages: {
     ...
     *
     * 1. The email provider is named only as a category. Google Drive is
     *    confirmed as where resumes are stored; the provider hosting the
     *    mailbox they arrive in is not, and a legal page should not guess.
     *    Name it here once it is confirmed.
     * 2. The Canadian section is a plain-language draft of rights under
     ...
     *
     * Both moved out of the body when the draft banner came off. A note to
