  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Si vous êtes au Canada", body: "Si vous êtes au Canada, vous pouvez demander quels renseignements nous détenons à votre sujet, en demander la rectification et retirer votre consentement — étant entendu que le retirer pendant un processus de recrutement y met fin. Les demandes et les CV sont conservés aux États-Unis : vos renseignements sortent donc du Canada lorsque vous nous les transmettez. Écrivez à info@zedventures.com, ou portez plainte auprès du Commissariat à la protection de la vie privée du Canada ou de votre commissaire provincial. [À CONFIRMER AVEC UN CONSEIL JURIDIQUE — rédaction en langage clair fondée sur la LPRPDE, la Loi 25 québécoise et la PIPA albertaine, à vérifier avant publication. Non revendiqués ici : le droit à la portabilité prévu par la Loi 25, et la personne responsable des renseignements personnels dont elle exige la publication — une personne à désigner, non une phrase à rédiger. La question préalable reste de savoir si ces obligations s'appliquent, ZEDventures n'ayant pas d'établissement au Canada.]" },
