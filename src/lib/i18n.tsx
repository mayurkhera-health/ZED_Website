...
const en = {
  ...
  careersPage: {
    ...
    legal: {
      ...
      privacy:
        "When you apply we collect the information in your resume and application — name, contact details, work history, education and anything else you choose to send. We use it to assess your application, to contact you about this and similar roles, and to meet our legal and immigration filing obligations. We keep applications for [retention period]. California residents can ask what we hold and request deletion at info@zedventures.com.",
    },
  },
  contact: {
  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "How long we keep it", body: "We keep contact form enquiries for one year from the date you write to us, and delete them after that unless they have become part of a client engagement. [CONFIRM — retention period for job applications. The careers page states a period, and the two must match.] Records we are required to retain for immigration filings are kept for the period the relevant regulations require." },
        { heading: "Your rights", body: "If you live in California, the CCPA and CPRA give you the right to know what personal information we hold about you, to have it deleted, to correct it, and not to be discriminated against for asking. Job applicants have these rights too. Write to info@zedventures.com and we will respond within the time the law allows. [CONFIRM WITH COUNSEL — Canadian coverage. The French pages are aimed at Quebec and Alberta, not the EU, so GDPR is not the question; Quebec's Law 25, Alberta's PIPA and PIPEDA are. Law 25 requires a named person responsible for the protection of personal information, published with their contact details, which is a change to this page rather than a clause in it. Both provinces also have their own breach-notification duties, and resumes from Canadian applicants are stored in the United States, which is a cross-border transfer that has to be disclosed. Ask counsel which of these attach given that ZEDventures has no Canadian establishment.]" },
  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Durée de conservation", body: "Nous conservons les demandes reçues via le formulaire pendant un an à compter de votre message, puis les supprimons, sauf si elles s'inscrivent dans un engagement client. [À CONFIRMER — durée de conservation des candidatures. La page carrières annonce une durée : les deux doivent concorder.] Les documents que nous devons conserver au titre des dépôts d'immigration le sont pour la durée exigée par la réglementation applicable." },
        { heading: "Vos droits", body: "Si vous résidez en Californie, le CCPA et le CPRA vous donnent le droit de savoir quelles données nous détenons, d'en demander la suppression ou la rectification, et de ne pas subir de traitement défavorable pour avoir exercé ces droits. Les candidats en bénéficient également. Écrivez à info@zedventures.com et nous répondrons dans le délai prévu par la loi. [À CONFIRMER AVEC UN CONSEIL JURIDIQUE — couverture canadienne. Les pages françaises visent le Québec et l'Alberta, non l'Union européenne : la question n'est donc pas le RGPD mais la Loi 25 québécoise, la PIPA albertaine et la LPRPDE. La Loi 25 exige la désignation d'une personne responsable de la protection des renseignements personnels, dont le nom et les coordonnées doivent être publiés — une modification de cette page, et non une clause à y insérer. Les deux provinces imposent aussi leurs propres obligations de notification en cas d'incident, et les CV des candidats canadiens sont conservés aux États-Unis, ce qui constitue une communication hors Québec à divulguer. Vérifier avec un conseil lesquelles de ces obligations s'appliquent, ZEDventures n'ayant pas d'établissement au Canada.]" },
