  ...
  legalPages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "Your rights", body: "If you live in California, the CCPA and CPRA give you the right to know what personal information we hold about you, to have it deleted, to correct it, and not to be discriminated against for asking. Job applicants have these rights too. Write to info@zedventures.com and we will respond within the time the law allows. [CONFIRM WITH COUNSEL — whether GDPR applies through the French-language version of this site, and if so add the lawful basis for each purpose above and the right to lodge a complaint with a supervisory authority.]" },
